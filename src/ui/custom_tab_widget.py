...
from ..chat.controllers.chat_controller import ChatController
...
class CustomTabWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Инициализация MVC компонентов для чата
        self.chat_controller = ChatController()
        
        self.init_ui()
        self.setup_style()
        
        # Создаем новый разговор при инициализации
        self.chat_controller.create_new_conversation()
    ...
    def create_chat_tab(self):
        """Создание вкладки ЧАТ с использованием MVC архитектуры"""
        # Создаем представление чата
        self.chat_view = ChatView()
        
        # Подключаем представление к контроллеру
        self.chat_controller.set_view(self.chat_view)
